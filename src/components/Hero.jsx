...
const Hero = () => {
  return (
    <div className='grid sm:grid-flow-col py-14 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 my-8'>
      ...
      <section>
        <p>Acredito que a tecnologia e o design caminham juntos, pois uma aplicação web, um software não são formados somente por códigos. Mas sim por um mundo interdisciplinar que envolveu escutar o usuário, observar, testar o produto, atender as necessidades e acessibilidades.
        </p>
        <p>
